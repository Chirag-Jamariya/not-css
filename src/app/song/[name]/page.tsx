      ...
      const fetchSongDetails = async () => {
        try {
          ...
          const searchResponse = await axios.get<GeniusSearchResponse>(
            `https://api.genius.com/search?q=${songName}&access_token=mIZKdaJAm2YZtAtPi6SIsl3_qI3CyY-5YmOcsv5Oc_cNU9SHZ6Dxgeu59zGvkcNl`
          );
          ...
          if (song) {
            ...
            const songDetailsResponse = await axios.get<GeniusSongDetailsResponse>(
              `https://api.genius.com/songs/${song.id}?access_token=mIZKdaJAm2YZtAtPi6SIsl3_qI3CyY-5YmOcsv5Oc_cNU9SHZ6Dxgeu59zGvkcNl`
            );
